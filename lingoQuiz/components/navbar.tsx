			...
			<NavbarContent className="hidden sm:flex basis-1/5 sm:basis-full " justify="end">
				...
				{isLoggedIn ? (
					<Dropdown placement="bottom-end" isOpen={isMenuOpen} onOpenChange={setIsMenuOpen}>
						<DropdownTrigger>
							<Avatar className="ml-4 cursor-pointer" size="lg" src="/images/avatar.jpg" alt="User Avatar" />
						</DropdownTrigger>
					...
					<div>
						<Button
							...
							href={`/login/`}
							color="primary"
							className="text-yellow-400 text-xl hover:text-yellow-300 font-bold py-2 px-4 transition-colors duration-300"
							onClick={onOpen} 
						>
							Login
						</Button>
